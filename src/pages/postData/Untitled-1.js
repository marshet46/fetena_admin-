    ...
    <form onSubmit={handleSubmit}>
        ...
        <ModalBody>
            <div className="form-group">
                <label className="pb-2" htmlFor="subjectname">Total Exam Time:</label>
                <input type="text" className="form-control" id="time" value={time} onChange={handleTimeChange} />
            </div>
            <div className="form-group">
                <label className="pb-2" htmlFor="category">Year:</label>
            ...
            <div className="form-group">
                <label className="pb-2" htmlFor="subject_id">select subject:</label>
