      ...
      {status === 'failed' && <p>Error creating question: {error}</p>}
        <ModalBody>
            <div className="form-group">
                ...
                <input type="text" className="form-control" id="question" value={question} onChange={handleQuestionChange} required/>
            </div>
            <br />
            <div className="form-group">
                <label className="pb-2" htmlFor="A">option A:</label>
                <input type="text" className="form-control" id="A" value={A} onChange={handleAChange} />
            </div>
            <br />
            <div className="form-group">
                <label className="pb-2" htmlFor="B">Option B:</label>
                <input type="text" className="form-control" id="B" value={B} onChange={handleBChange} />
                ...
                <input type="text" className="form-control" id="D" value={D} onChange={handleDChange} />
            </div>
            </div> <div className="form-group">
                <label className="pb-2" htmlFor="explanation">expnation:</label>
                <input type="text" className="form-control" id="explanation" value={explanation} onChange={handleExplanationChange} />
            </div>
            <br />
             <div className="form-group">
            ...
            <div className="form-group">
                ...
                <input type="text" className="form-control" id="passage" value={passage} onChange={handlePassageChange} />
            </div>
            <br />
            <div className="form-group">
                <label className="pb-2" htmlFor="answer"> Answer:</label>
                <select className="form-control" id="answer" value={answer} onChange={handleAnswerChange}>
            ...
            <div className="form-group">
                ...
                <select className="form-control" id="subjectId" value={subjectId} onChange={handleSubjectIdChange}>
                    <option value="">Select </option>
            ...
            <div className="form-group">
                ...
                <select className="form-control" id="examId" value={examId} onChange={handleExamIdChange}>
                    <option value="">Select </option>
                    {exams.map(exam => (
            ...
            <br />
            <div className="form-group">
                <label className="pb-2" htmlFor="image"> Image</label>
